...
// Arrays of products
camArr = [
    {caption:"Canon EOS", alt:"Canon", url:"./img/cam01.jpg", text:"Canon EOS Camera", description:"Excellent condition. Digital.", price:"99.99", newItem:"Y", id:"1901"},
    {caption:"Elner Camera", alt:"Elner", url:"./img/cam02.jpg", text:"Elner Camera", description:"Good condition. Functional.", price:"99.99", newItem:"Y", id:"1902"},
    {caption:"Canon AE-1", alt:"Canon", url:"./img/cam03.jpg", text:"Canon AE-1 Camera", description:"Excellent condition. Takes 35mm film.", price:"99.99", newItem:"N", id:"1903"},
    {caption:"Revue Zoom P&S", alt:"Revue", url:"./img/cam04.jpg", text:"Revue Zoom P&S Camera", description:"Poor condition. Functional. Takes 35mm film.", price:"99.99", newItem:"N", id:"1904"},
	{caption:"Polaroid One Step 2", alt:"Polaroid", url:"./img/cam05.jpg", text:"Polaroid One Step 2 Camera", description:"Excellent condition. Takes i-type and 600 film.", price:"99.99", newItem:"N", id:"1905"},
	{caption:"Reflekta II", alt:"Reflekat", url:"./img/cam06.jpg", text:"Reflekta II Camera", description:"Excellent condition. Takes 120 film. 6x6 frame size.", price:"99.99", newItem:"N", id:"1906"},
	{caption:"Kodak Retina", alt:"Kodak", url:"./img/cam07.jpg", text:"Kodak Retina Camera", description:"Good condition. Takes 35mm film.", price:"99.99", newItem:"N", id:"1907"},
	{caption:"Pentax MV-1", alt:"Pentax", url:"./img/cam08.jpg", text:"Pentax MV-1", description:"Excellent condition. Takes 35mm film.", price:"99.99", newItem:"N", id:"1908"}
];

lensArr = [
	{caption:"Minolta Rokkor", alt:"Minolta", url:"./img/lens01.jpg", text:"Minolta Lens", description:"Rokkor f1.4 lens. Excellent condition.", price:"59.99", newItem:"Y", id:"1801"},
	{caption:"Nikon Nikkor", alt:"Nikon", url:"./img/lens02.jpg", text:"Nikon Lens", description:"Nikon 50mm f1.8. Excellent condition.", price:"59.99", newItem:"Y", id:"1802"},
	{caption:"Canon", alt:"Canon", url:"./img/lens03.jpg", text:"Canon Lens", description:"Canon 24-70mm f4. Good condition.", price:"59.99", newItem:"N", id:"1803"},
	{caption:"Leitz Wetzlar", alt:"Leitz", url:"./img/lens04.jpg", text:"Leitz Lens", description:"Wetzlar 28mm f2.8. Good condition.", price:"59.99", newItem:"N", id:"1804"},
	{caption:"Caspeco", alt:"Caspeco", url:"./img/lens05.jpg", text:"Caspeco Lens", description:"28mm f2.8. Good condition.", price:"59.99", newItem:"N", id:"1805"},
	{caption:"Nikon Nikkor", alt:"Nikon", url:"./img/lens06.jpg", text:"Nikon Lens", description:"Nikkor DX 10-20mm. Excellent condition.", price:"59.99", newItem:"N", id:"1806"},
	{caption:"Canon", alt:"Canon", url:"./img/lens07.jpg", text:"Canon Lens", description:"Canon 135mm. Excellent condition.", price:"59.99", newItem:"N", id:"1807"}
];

filmArr = [
	{caption:"Kodak Gold", alt:"Kodak", url:"./img/film01.jpg", text:"Kodak Gold", description:"Colour negative. 400 speed.", price:"9.99", newItem:"Y", id:"1701"},
	{caption:"Ilford HP5 plus", alt:"Ilford", url:"./img/film02.jpg", text:"Ilford HP5 Plus", description:"Black and White. 400 speed.", price:"9.99", newItem:"Y", id:"1702"},
	{caption:"Kodak Portra", alt:"Kodak", url:"./img/film03.jpg", text:"Kodak Portra", description:"Colour negative. 400 speed.", price:"9.99", newItem:"N", id:"1703"},
	{caption:"Ilford FP4 Plus", alt:"Ilford", url:"./img/film04.jpg", text:"Ilford FP4 Plus", description:"Black and White. 125 speed.", price:"9.99", newItem:"N", id:"1704"}
];

updatesArr = [
	{title: "6 Items added", content:"We've added six new items to the store.", date:"August 7, 2020"},
	{title: "Welcome to Captured Essence", content:"This website was built for Web222 at Seneca College.", date:"August 6, 2020"}
];
